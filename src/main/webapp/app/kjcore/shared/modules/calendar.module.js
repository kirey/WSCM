...
var Calendar = (function () {
    ...
    Object.defineProperty(Calendar.prototype, "dateFormat", {
        get: function () {
    ...
    Calendar.prototype.updateInputfield = function () {
        if (this.value) {
            ...
            if (this.timeOnly) {
                ...
                formattedValue = this.formatDate(this.value, this._dateFormat);
                if (this.showTime) {
                    formattedValue += ' ' + this.formatTime(this.value);
                }
            }
    ...
    Calendar.prototype.updateModel = function () {
        if (this.dataType == 'date')
            ...
            this.onModelChange(this.formatDate(this.value, this._dateFormat));
    };
    ...
    Calendar.prototype.showOverlay = function (event) {
        ...
        this.overlay.style.zIndex = String(++primeng_1.DomHandler.zindex);
    };
    ...
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], Calendar.prototype, "_dateFormat", void 0);
    __decorate([
        core_1.Input(), 
    ...
    Calendar = __decorate([
        core_1.Component({
            ...
            providers: [primeng_1.DomHandler, exports.CALENDAR_VALUE_ACCESSOR]
        }), 
        __metadata('design:paramtypes', [core_1.ElementRef, primeng_1.DomHandler, core_1.Renderer])
    ], Calendar);
    return Calendar;
}());
...
var CalendarModule = (function () {
    ...
    CalendarModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, primeng_1.ButtonModule, primeng_1.InputTextModule],
            exports: [Calendar, primeng_1.ButtonModule, primeng_1.InputTextModule],
