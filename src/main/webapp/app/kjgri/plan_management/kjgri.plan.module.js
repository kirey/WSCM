        ...
        core_1.NgModule({
            imports: [
                ...
                ng2_translate_1.TranslateModule.forRoot({
                    ...
                    useFactory: function (http) { return new ng2_translate_1.TranslateStaticLoader(http, kjgri_constants_1.KJGriConstants.TRANSLATION_URL_PREFIX + 'planManagement', ''); },
                    deps: [http_1.Http]
                })
            ],
            declarations: [
                kjgri_plan_cmp_1.PlanManagementCmp
            ],
            providers: [
                kjgri_plan_service_1.PlanManagementService,
                kjgri_constants_1.KJGriConstants,
                kjgri_history_service_1.KJGriHistoryService,
                {
                    provide: http_1.Http,
...
exports.PlanManagementModule = PlanManagementModule;
//# sourceMappingURL=kjgri.plan.module.js.map