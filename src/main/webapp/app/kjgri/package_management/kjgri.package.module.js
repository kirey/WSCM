...
var kjgri_package_routes_1 = require('./kjgri.package.routes');
var utility_module_1 = require('../../kjcore/shared/modules/utility.module');
var kjgri_constants_1 = require('../kjgri.constants');
var kjgri_package_cmp_1 = require('./kjgri.package.cmp');
var kjgri_package_service_1 = require('./kjgri.package.service');
var PackageManagementModule = (function () {
    function PackageManagementModule() {
    }
    PackageManagementModule = __decorate([
        core_1.NgModule({
            imports: [
                utility_module_1.UtilityModule,
                kjgri_package_routes_1.ROUTING,
                ...
                ng2_translate_1.TranslateModule.forRoot({
                    ...
                    useFactory: function (http) { return new ng2_translate_1.TranslateStaticLoader(http, kjgri_constants_1.KJGriConstants.TRANSLATION_URL_PREFIX + 'packageManagement', ''); },
                    deps: [http_1.Http]
                })
            ],
            declarations: [
                kjgri_package_cmp_1.PackageManagementCmp
            ],
            providers: [
                kjgri_package_service_1.PackageManagementService,
...
exports.PackageManagementModule = PackageManagementModule;
//# sourceMappingURL=kjgri.package.module.js.map