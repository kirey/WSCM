...
var kjgri_style_routes_1 = require('./kjgri.style.routes');
var utility_module_1 = require('../../kjcore/shared/modules/utility.module');
var kjgri_constants_1 = require('../kjgri.constants');
var kjgri_style_cmp_1 = require('./kjgri.style.cmp');
var kjgri_style_service_1 = require('./kjgri.style.service');
var StyleManagementModule = (function () {
    function StyleManagementModule() {
    }
    StyleManagementModule = __decorate([
        core_1.NgModule({
            imports: [
                utility_module_1.UtilityModule,
                kjgri_style_routes_1.ROUTING,
                ...
                ng2_translate_1.TranslateModule.forRoot({
                    ...
                    useFactory: function (http) { return new ng2_translate_1.TranslateStaticLoader(http, kjgri_constants_1.KJGriConstants.TRANSLATION_URL_PREFIX + 'styleManagement', ''); },
                    deps: [http_1.Http]
                })
            ],
            declarations: [
                kjgri_style_cmp_1.StyleManagementCmp
            ],
            providers: [
                kjgri_style_service_1.StyleManagementService,
    ...
    ], StyleManagementModule);
    return StyleManagementModule;
}());
exports.StyleManagementModule = StyleManagementModule;
//# sourceMappingURL=kjgri.style.module.js.map