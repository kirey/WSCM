...
import { DataTableModule, SharedModule, CheckboxModule, CalendarModule } from 'primeng/primeng';
...
import { ROUTING } from './control_panel.routes';
...
@NgModule({
    imports: [
        ...
        TranslateModule.forRoot({
            ...
            useFactory: (http: Http) => new TranslateStaticLoader(http, KJGriConstants.TRANSLATION_URL_PREFIX + 'controlPanel', ''),
            deps: [Http]
        })
    ],
    declarations: [
