...
var kjgri_history_routes_1 = require('./kjgri.history.routes');
...
var KJGriHistoryModule = (function () {
    function KJGriHistoryModule() {
    }
    KJGriHistoryModule = __decorate([
        core_1.NgModule({
            imports: [
                utility_module_1.UtilityModule,
                kjgri_history_routes_1.ROUTING,
                ...
                ng2_translate_1.TranslateModule.forRoot({
                    ...
                    useFactory: function (http) { return new ng2_translate_1.TranslateStaticLoader(http, kjgri_constants_1.KJGriConstants.TRANSLATION_URL_PREFIX + 'history', ''); },
                    deps: [http_1.Http]
                })
            ],
            declarations: [
                kjgri_history_cmp_1.KJGriHistoryCmp
            ],
            providers: [
    ...
    return KJGriHistoryModule;
}());
exports.KJGriHistoryModule = KJGriHistoryModule;
//# sourceMappingURL=kjgri.history.module.js.map