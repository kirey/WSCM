...
var PasswordChangeService = (function () {
     ...
     * @author Mario Petrovic
     */
    PasswordChangeService.prototype.forgotPasswordRequestRest = function (username) {
        return this._http.get('rest/common/users/noAuth/forgotPassword?username=' + username)
            .map(function (res) { return res.json(); })
            .catch(utility_service_1.UtilityService.handleError);
    };
    /**
