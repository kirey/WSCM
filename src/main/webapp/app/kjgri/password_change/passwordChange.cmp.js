...
var PasswordChangeCmp = (function () {
     ...
     * @author Mario Petrovic
     */
    PasswordChangeCmp.prototype.forgotPasswordRequest = function (username) {
        var _this = this;
        this.subscriptions['forgotPasswordRequest'] = this._passwordChangeService.forgotPasswordRequestRest(username).subscribe(function (res) {
