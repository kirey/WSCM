...
import { ROUTING } from './kjgri.placeholder.routes';
...
@NgModule({
    imports: [
        ...
        TranslateModule.forRoot({
            ...
            useFactory: (http: Http) => new TranslateStaticLoader(http, KJGriConstants.TRANSLATION_URL_PREFIX + 'placeholderManagement', ''),
            deps: [Http]
        })
    ],
    declarations: [
...
export class PlaceholderManagementModule { }