...
var kjgri_placeholder_routes_1 = require('./kjgri.placeholder.routes');
var utility_module_1 = require('../../kjcore/shared/modules/utility.module');
var kjgri_constants_1 = require('../kjgri.constants');
var kjgri_placeholder_cmp_1 = require('./kjgri.placeholder.cmp');
var kjgri_placeholder_service_1 = require('./kjgri.placeholder.service');
var PlaceholderManagementModule = (function () {
    function PlaceholderManagementModule() {
    }
    PlaceholderManagementModule = __decorate([
        core_1.NgModule({
            imports: [
                utility_module_1.UtilityModule,
                kjgri_placeholder_routes_1.ROUTING,
                ...
                ng2_translate_1.TranslateModule.forRoot({
                    ...
                    useFactory: function (http) { return new ng2_translate_1.TranslateStaticLoader(http, kjgri_constants_1.KJGriConstants.TRANSLATION_URL_PREFIX + 'placeholderManagement', ''); },
                    deps: [http_1.Http]
                })
            ],
            declarations: [
                kjgri_placeholder_cmp_1.PlaceholderManagementCmp
            ],
            providers: [
                kjgri_placeholder_service_1.PlaceholderManagementService,
    ...
    ], PlaceholderManagementModule);
    return PlaceholderManagementModule;
}());
exports.PlaceholderManagementModule = PlaceholderManagementModule;
//# sourceMappingURL=kjgri.placeholder.module.js.map