...
var kjgri_passwordChange_cmp_1 = require('./kjgri.passwordChange.cmp');
var kjgri_passwordChange_service_1 = require('./kjgri.passwordChange.service');
var kjgri_passwordChange_routes_1 = require('./kjgri.passwordChange.routes');
...
var PasswordChangeModule = (function () {
    ...
    PasswordChangeModule = __decorate([
        core_1.NgModule({
            imports: [
                kjgri_passwordChange_routes_1.ROUTING,
            ...
            declarations: [
                kjgri_passwordChange_cmp_1.PasswordChangeCmp
            ],
            providers: [
                kjgri_passwordChange_service_1.PasswordChangeService,
                {
                    provide: http_1.Http,
...
//# sourceMappingURL=kjgri.passwordChange.module.js.map