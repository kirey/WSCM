...
var kjgri_passwordChange_service_1 = require('./kjgri.passwordChange.service');
var models_1 = require('./models');
var ng2_translate_1 = require('ng2-translate');
var restResponse_model_1 = require('../../kjcore/shared/models/restResponse.model');
...
var PasswordChangeCmp = (function () {
    ...
    PasswordChangeCmp.prototype.ngOnInit = function () {
        ...
        this.formErrors = new restResponse_model_1.RestResponse();
        this.emailErrors = new restResponse_model_1.RestResponse();
    ...
    PasswordChangeCmp = __decorate([
        core_1.Component({
            moduleId: module.id,
            templateUrl: 'kjgri.passwordChange.cmp.html',
            encapsulation: core_1.ViewEncapsulation.None
        }), 
        __metadata('design:paramtypes', [kjgri_passwordChange_service_1.PasswordChangeService, utility_service_1.UtilityService, app_service_1.AppService, router_1.ActivatedRoute, ng2_translate_1.TranslateService])
    ], PasswordChangeCmp);
    return PasswordChangeCmp;
}());
exports.PasswordChangeCmp = PasswordChangeCmp;
//# sourceMappingURL=kjgri.passwordChange.cmp.js.map