...
var clientCompanies_cmp_1 = require('./clientCompanies.cmp');
...
var clientCompanies_routes_1 = require('./clientCompanies.routes');
var kjgri_constants_1 = require('../kjgri.constants');
var ClientCompaniesModule = (function () {
    function ClientCompaniesModule() {
    }
    ClientCompaniesModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                clientCompanies_routes_1.ROUTING,
                ...
                ng2_translate_1.TranslateModule.forRoot({
                    ...
                    useFactory: function (http) { return new ng2_translate_1.TranslateStaticLoader(http, kjgri_constants_1.KJGriConstants.TRANSLATION_URL_PREFIX + 'clientCompanies', ''); },
                    deps: [http_1.Http]
                })
            ],
            declarations: [
                clientCompanies_cmp_1.ClientCompaniesCmp,
            ],
            providers: [
                clientCompanies_service_1.ClientCompaniesService,
                {
                    provide: http_1.Http,
    ...
    return ClientCompaniesModule;
}());
exports.ClientCompaniesModule = ClientCompaniesModule;
//# sourceMappingURL=clientCompanies.module.js.map