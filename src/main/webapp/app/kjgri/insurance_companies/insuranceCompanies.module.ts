...
import { ROUTING } from './insuranceCompanies.routes';
...
@NgModule({
    imports: [
        ...
        TranslateModule.forRoot({
            ...
            useFactory: (http: Http) => new TranslateStaticLoader(http, KJGriConstants.TRANSLATION_URL_PREFIX + 'insuranceCompanies', ''),
            deps: [Http]
        })
    ],
    declarations: [
