...
import { ClientService } from './test-home.service';
...
export class TestHomeComponent implements OnInit, OnDestroy {
  ...
  constructor(public router: Router,
     public auth: AuthService, public clientService: ClientService, public wsService: SocketService, private _http: Http) {
  }
